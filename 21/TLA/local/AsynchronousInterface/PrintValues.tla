  ...
  /\ PrintVal("Here's a record: ",
              [ [game |-> "baseball", player |-> "Marris", homers |-> 61]
                   EXCEPT !.player = "McGuire",
                          !.homers = @+9 ] )
  /\ PrintVal("xsadf", [ field1 |-> 1, field2 |-> "abc"].field2)
  /\ PrintVal("adfas", [ [ field1 |-> 1, field2 |-> "abc"] EXCEPT !.field2 = 27 ].field1)
  /\ PrintVal("adfas", [ [ field1 |-> 1, field2 |-> "abc"] EXCEPT !.field2 = 27 ].field2)
  /\ PrintVal("aasdf", [ [ field1 |-> 1, field2 |-> "abc"] EXCEPT !.field1 = @ + 7].field1)
  /\ PrintVal("sdfkj", [a : {"a"}, b : {"b"}, c : {"c"}])
  /\ PrintVal("fasfa", [sign : {"+", "-"}, val : 1..3])
  /\ PrintVal("asfaa", [entry : {0, 2, 4}])
=============================================================================
